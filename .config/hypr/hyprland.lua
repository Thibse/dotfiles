...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd('SSH_AUTH_SOCK="${XDG_RUNTIME_DIR}/ssh-agent.socket" keepassxc')
end)
...
hl.bind(mainMod .. " + U", hl.dsp.exec_cmd("loginctl lock-session"))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("~/.scripts/picker")) -- color picker
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd('grim -g "$(slurp)"')) -- screenshot to clipboard
hl.bind(
	mainMod .. " + SHIFT + S",
	hl.dsp.exec_cmd('grim -g "$(slurp)" $HOME/Pictures/Screenshots/$(date +" % s_grim.png")')
) -- screenshot
...
local resizefactor = 40

hl.bind(mainMod .. " + left", hl.dsp.window.resize({ x = -resizefactor, y = 0, relative = true }), { repeating = true })
hl.bind(mainMod .. " + right", hl.dsp.window.resize({ x = resizefactor, y = 0, relative = true }), { repeating = true })
hl.bind(mainMod .. " + up", hl.dsp.window.resize({ x = 0, y = resizefactor, relative = true }), { repeating = true })
hl.bind(mainMod .. " + down", hl.dsp.window.resize({ x = 0, y = -resizefactor, relative = true }), { repeating = true })
...
-- Requires playerctl
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("playerctl n-p spotify ext"), { locked = true })
...
hl.bind("SHIFT + XF86AudioLowerVolume", hl.dsp.exec_cmd("playerctl -p spotify volume 0.05-"), { locked = true })
